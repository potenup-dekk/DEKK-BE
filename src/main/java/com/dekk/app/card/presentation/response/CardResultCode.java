...
public enum CardResultCode implements ResultCode {
    GUEST_CARD_LIST_SUCCESS(HttpStatus.OK, "SC200001", "비회원 카드 목록 조회에 성공했습니다."),
    MEMBER_CARD_LIST_SUCCESS(HttpStatus.OK, "SC200002", "회원 카드 목록 조회에 성공했습니다."),
    CARD_APPROVE_SUCCESS(HttpStatus.OK, "SC200003", "카드 승인에 성공했습니다."),
    CARD_REJECT_SUCCESS(HttpStatus.OK, "SC200004", "카드 반려에 성공했습니다."),
    ...
    CARD_DELETE_REQUEST_SUCCESS(HttpStatus.OK, "SC200008", "카드 삭제 요청이 성공했습니다.");
